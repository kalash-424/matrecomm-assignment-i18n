...
// Define your GlobeIcon component for the button
const GlobeIcon = () => (
...
export const LanguageSelector = () => {
    ...
    useEffect(() => {
      document.body.dir = currLangObj.dir || 'ltr';
    }, [currLang])
    ...
    return (
      ...
      <div style={{ marginLeft: currLangObj.dir === 'rtl' ? '2%' : '', marginRight: currLangObj.dir !== 'rtl' ? '2%' : '' }}>
        <span
          className={`fi fi-${currentCountryCode} mx-2`}
        ></span>
      </div>
      </>
    );
